...
@section('title', 'Edit Topik Konsultasi')

@section('content')
<div class="max-w-3xl mx-auto px-6">
    <div class="bg-white shadow-xl rounded-3xl p-10 border border-gray-200">
        <h2 class="text-xl font-bold mb-10 text-left text-emerald-500">Edit Topik Konsultasi</h2>

        <form action="{{ route('admin.topik-konsultasi.update', $topik->id) }}" method="POST"
            ...
            <div>
                ...
                <input type="text" name="nama_topik" value="{{ old('nama_topik', $topik->nama_topik) }}"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    ...
                    required>{{ old('deskripsi', $topik->deskripsi) }}</textarea>
