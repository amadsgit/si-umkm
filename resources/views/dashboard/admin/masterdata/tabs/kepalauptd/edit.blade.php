...
@section('title', 'Edit Data Kepala UPTD')

@section('content')
<div class="max-w-4xl mx-auto px-6">
    <div class="bg-white shadow-xl rounded-3xl p-10 border border-gray-200">
        <h2 class="text-xl font-bold mb-10 text-left text-emerald-500">Edit Kepala UPTD</h2>

        <form action="{{ route('admin.kepalauptd.update', $kepala->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="username" value="{{ old('username', $kepala->user->username) }}"
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email', $kepala->user->email) }}"
            ...
            <div>
                ...
                <input type="text" name="phone" value="{{ old('phone', $kepala->user->phone) }}"
            ...
            {{-- Password --}}
            <div>
                <label class="block mb-2 text-sm font-semibold text-gray-700">Password (Kosongkan jika tidak
                    diubah)</label>
            ...
            <div>
                ...
                <input type="text" name="nip" value="{{ old('nip', $kepala->nip) }}"
            ...
            <div>
                ...
                <input type="text" name="jabatan" value="{{ old('jabatan', $kepala->jabatan) }}"
            ...
            <div class="md:col-span-2">
                ...
                <img src="{{ asset('storage/' . $kepala->foto_profil) }}" class="h-32 mt-4 rounded-lg shadow"
                    alt="Foto Profil">
                @endif
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <select name="status_aktif"
                    ...
                    <option value="1" {{ old('status_aktif', $kepala->status_aktif) == '1' ? 'selected' : '' }}>Aktif
                    </option>
                    <option value="0" {{ old('status_aktif', $kepala->status_aktif) == '0' ? 'selected' : '' }}>Tidak
                        Aktif</option>
                </select>
