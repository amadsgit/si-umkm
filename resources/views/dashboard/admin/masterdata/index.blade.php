...
<div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="tabs" role="tablist">
            <li class="me-2">
                <button class="tab-button inline-block p-4 rounded-t-lg border-b-2" data-tab="user" type="button">
                    Data User
                </button>
            </li>
            <li class="me-2">
                <button class="tab-button inline-block p-4 rounded-t-lg border-b-2" data-tab="umkm" type="button">
                    Data UMKM
                </button>
            </li>
            <li class="me-2">
                <button class="tab-button inline-block p-4 rounded-t-lg border-b-2" data-tab="konsultan" type="button">
                    Data Konsultan
                </button>
            </li>
            <li class="me-2">
                <button class="tab-button inline-block p-4 rounded-t-lg border-b-2" data-tab="kepala" type="button">
                    Data Kepala UPTD
                </button>
            </li>
        </ul>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        buttons[0].classList.add("border-emerald-600", "text-emerald-600");
        ...
        buttons.forEach(button => {
            button.addEventListener("click", function () {
                ...
                // Remove active class
                buttons.forEach(btn => btn.classList.remove("border-emerald-600", "text-emerald-600"));
