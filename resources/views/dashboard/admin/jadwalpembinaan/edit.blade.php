...
@section('title', 'Edit Jadwal Pembinaan')

@section('content')
<div class="max-w-4xl mx-auto px-6">
    <div class="bg-white shadow-xl rounded-3xl p-10 border border-gray-200">
        <h2 class="text-xl font-bold mb-10 text-left text-emerald-500">Edit Jadwal Pembinaan</h2>

        <form action="{{ route('admin.jadwal-pembinaan.update', $jadwalPembinaan->id) }}" method="POST"
            ...
            <div>
                ...
                <select name="jenis_id"
                    ...
                    <option value="{{ $jenis->id }}" {{ old('jenis_id', $jadwalPembinaan->jenis_id) == $jenis->id ?
                        'selected' : '' }}>
            ...
            <div>
                ...
                <select name="topik_pembinaan_id"
                    ...
                    <option value="{{ $topik->id }}" {{ old('topik_pembinaan_id', $jadwalPembinaan->topik_pembinaan_id)
                        == $topik->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text" name="judul" value="{{ old('judul', $jadwalPembinaan->judul) }}"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4"
                    class="w-full bg-gray-100 rounded-xl border @error('deskripsi') border-red-500 @else border-gray-300 @enderror focus:ring-emerald-500 focus:border-emerald-500 px-4 py-3 transition">{{ old('deskripsi', $jadwalPembinaan->deskripsi) }}</textarea>
            ...
            <div>
                ...
                <input type="date" name="tanggal" value="{{ old('tanggal', \Carbon\Carbon::parse($jadwalPembinaan->tanggal)->format('Y-m-d')) }}"
                    class="w-full bg-gray-100 rounded-xl border @error('tanggal') border-red-500 @else border-gray-300 @enderror
                           focus:ring-emerald-500 focus:border-emerald-500 px-4 py-3 transition" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" name="waktu_mulai"
                        value="{{ old('waktu_mulai', \Carbon\Carbon::parse($jadwalPembinaan->waktu_mulai)->format('H:i')) }}" class="w-full bg-gray-100 rounded-xl border @error('waktu_mulai') border-red-500 @else border-gray-300 @enderror
                               focus:ring-emerald-500 focus:border-emerald-500 px-4 py-3 transition" required>
                ...
                <div>
                    ...
                    <input type="time" name="waktu_selesai"
                        value="{{ old('waktu_selesai', \Carbon\Carbon::parse($jadwalPembinaan->waktu_selesai)->format('H:i')) }}" class="w-full bg-gray-100 rounded-xl border @error('waktu_selesai') border-red-500 @else border-gray-300 @enderror
                               focus:ring-emerald-500 focus:border-emerald-500 px-4 py-3 transition" required>
            ...
            <div>
                ...
                <select name="metode"
                    ...
                    <option value="offline" {{ old('metode', $jadwalPembinaan->metode) == 'offline' ? 'selected' : ''
                        }}>Offline</option>
                    <option value="online" {{ old('metode', $jadwalPembinaan->metode) == 'online' ? 'selected' : ''
                        }}>Online</option>
                </select>
            ...
            <div>
                ...
                <input type="text" name="lokasi" value="{{ old('lokasi', $jadwalPembinaan->lokasi) }}"
            ...
            <div>
                ...
                <input type="number" name="kuota" value="{{ old('kuota', $jadwalPembinaan->kuota) }}"
            ...
            <div>
                ...
                @if($jadwalPembinaan->thumbnail)
                <div class="mb-3">
                    <img src="{{ asset('storage/'.$jadwalPembinaan->thumbnail) }}" alt="Thumbnail"
