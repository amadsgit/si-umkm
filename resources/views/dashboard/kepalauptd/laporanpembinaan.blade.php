...
<div class="p-6 space-y-8">
    ...
    <div class="mb-6 border-b border-gray-200">
        <nav class="flex space-x-6">
            <a href="{{ route('dashboard.kepalauptd.laporan') }}"
                class="pb-2 border-b-2 {{ request()->routeIs('dashboard.kepalauptd.laporan.*') ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-blue-600 hover:border-blue-600' }} font-medium text-sm">
                Laporan Kegiatan Pembinaan
            </a>
            <a href="{{ route('dashboard.kepalauptd.laporankonsultasi') }}"
                class="pb-2 border-b-2 {{ request()->routeIs('dashboard.kepalauptd.laporankonsultasi.*') ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-600 hover:text-blue-600 hover:border-blue-600' }} font-medium text-sm">
    ...
    <div class="bg-white rounded-2xl shadow-md p-6">
        ...
        <div class="flex gap-4 mb-4">
            <a href="{{ route('laporan.export.pembinaan') }}"
